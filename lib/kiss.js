...
class Kiss {
  ...
  async _finishBuild() {
    ...
    // When this build settled. `duration` is measured to here and not to the
    // moment the report happens to be assembled, or a refresh hours into a
    // watch session would report the session's idle time as build time.
