 ...
 * @returns {LlmsEntry[]}
 */
export function buildLlmsEntries(
  stack,
  { siteUrl, buildDir, sections = {}, trailingSlash = true },
) {
  return stack
    .filter((entry) => {
      ...
      return (
        ...
        // Withdrawn for the reason the sitemap withdraws it: the page itself
        // says another URL is the one to cite.
        !options.canonical &&
