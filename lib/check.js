 ...
 * `node_modules/kiss-ssg` walking up from `cwd`, the way Node resolves it.
 ...
 * `null` when no `node_modules/kiss-ssg` exists above `cwd`
 */
export function describeEngine({ cwd }) {
